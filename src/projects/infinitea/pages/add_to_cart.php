...
&& !empty($_POST['grammage']) && !empty($_POST['quantity']) && !empty($_POST['product_name']) && !empty($_POST['product_image'])
){
    // FORMULAIRE BIEN REMPLI DONC ON GERE LES DONNEES
    
        $product_ID = $_POST['product_ID'];
        $weight = $_POST['grammage'];
    ...
    $sql = "INSERT INTO carts (product_ID, product_name, product_image, weight, quantity, user_ID)
    VALUES (:product_ID, :product_name, :product_image, :weight, :quantity, :user_ID)";
