...
<div id="noir2" class="categoryDiv">
  ...
  <?php
    foreach ($thes_noir as $the_noir){
      ...
      echo '<div class="hiddenProduct w-full sm:wfull md:w-80 lg:w-80 xl:w-80 min-w-20  mb-4 flex flex-col items-center bg-stone-100 p-4 rounded-lg shadow-md">';
      echo '<h3 class="sm:text-5xl md:text-4xl lg:text-4xl xl:text-5xl mb-1">'.$the_noir['name'].'</h3>';
